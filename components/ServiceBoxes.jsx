...
const ServiceBoxes = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-center items-center gap-10 p-6 px-28">
      {services.map((service) => (
        <div 
          key={service.id} 
          className="bg-white flex flex-col items-center w-full sm:w-1/3 p-6 shadow-lg rounded-lg text-center border border-gray-100 transition-transform transform hover:scale-105 hover:bg-yellow-50 duration-300"
        >
          {service.icon}
